...
//           <tbody>
//             {bookings.map((booking, index)=>(
//               <tr key={index} className='border-t border-borderColor text-primary-dull'>
//                 <td className='p-3 flex items-center gap-3'>
//                   <img src={booking.instrument.image} alt="" className='h-12 w-12 aspect-square rounded-md object-cover'/>
//                   <p className='font-medium max-md:hidden'>{booking.instrument.brand} {booking.instrument.model}</p>
//                 </td>
//                 <td className='p-3 max-md:hidden'>
...
//                 <td className='p-3 max-md:hidden'>
//                   <span className='bg-light px-3 py-1 rounded-full text-xs'>Offline</span>
//                 </td>


//                 <td className='p-3'>
//                   {booking.status === 'pending' ? (
//                     <select onChange={e => changeBookingStatus(booking._id, e.target.value)} value={booking.status} className='px-2 py-1.5 mt-1 text-primary-dull border border-borderColor rounded-md outline-none'>
//                       <option value="pending">Pending</option>
//                       <option value="cancelled">Cancelled</option>
//                       <option value="confirmed">Confirmed</option>
//                     </select>
