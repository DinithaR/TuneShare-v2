...
//   useEffect(() => {
//     setInstrument(instruments.find(instrument => instrument._id === id))
//   }, [instruments, id])
...
//           <div className='space-y-6'>
//             <div>
//               <h1 className='text-3xl font-bold text-gray-800'>{instrument.brand} {instrument.model}</h1>
//               <p className='text-gray-500 text-lg mt-2'>{instrument.category}</p>
//             </div>
//             <hr className='border-borderColor my-6'/>

//             <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4'>
//               {[
//                 {icon: assets.location_icon, text: instrument.location}
//               ].map(({icon, text}) => (
//                 <div key={text} className='flex flex-col items-center bg-light p-4 rounded-lg border border-borderColor'>
//                   <img src={icon} alt="" className='h-5 w-5 mb-2 opacity-70'/>
//                   <span className='text-sm text-gray-600 text-center'>{text}</span>
...
//             <div className='flex items-center justify-between'>
//               <span className='text-2xl text-primary-dull font-semibold'>
//                 {currency}{instrument.pricePerDay}
//               </span>
//               <span className='text-base text-gray-400 font-normal'>per day</span>
//             </div>
