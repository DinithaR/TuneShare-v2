...
//           className="px-4 py-2 font-semibold rounded-md transition-all duration-200 hover:bg-pink-50"
...
//           className="px-6 py-2 font-semibold rounded-lg transition-all duration-200 hover:shadow-md"
//           style={{
//             backgroundColor: 'var(--color-primary)',
//             color: 'white',
//           }}
