...
//       <h1 className="text-4xl md:text-5xl font-semibold">Instruments on Rent</h1>

//       <form
//         className="flex flex-col md:flex-row items-center justify-between p-6
//         rounded-lg md:rounded-full w-full max-w-2xl bg-white shadow-lg
//         gap-y-6 md:gap-y-0 md:gap-x-8"
//       >
//         {/* Pickup Location */}
...
//       <img src={assets.hero_img} alt="hero" className="max-h-100" />
//     </div>
//   );
// };
